        ...
        <div className="bg-[#1A1A19] py-8 w-full">
            <div className="flex flex-col items-center">
                <div className="flex justify-between w-full px-8 items-center mb-4">
                    <h3 className="text-white text-2xl font-bold" style={{lineHeight:"24px"}}>Continue</h3>
...
const MovieCard = ({ movie, isActive }:any) => (
    <div className={`bg-[#16181E] border-[#16181E] border-[1px] p-4 rounded-lg w-[250px] transition-all duration-300 ${
